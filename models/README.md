...
- `sign_detector_yolo11n_any_sign_ncnn_model/`: NCNN export for Pi-side detector benchmarking.
- `sign_classifier_yolo11n_raw_min100_ncnn_model/`: NCNN export for Pi-side classifier benchmarking.
